        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            if(contador_errores>0)
            {
                button2.Enabled = false;
                 ...
                 this.label3.Text ="ERRORES: "+contador_errores;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
           ...
           for (int x = 0; x < dataGridView2.RowCount; x++)
           {
            ...
            if (contador_error_compilar == 0)
            {
                ...
                using (StreamWriter writer = new StreamWriter(Environment.CurrentDirectory + "\\COMPILACION EN C++.txt", false))
                ...
                textBox2.Clear();
                textBox2.Text = System.IO.File.ReadAllText(Environment.CurrentDirectory + "\\COMPILACION EN C++.txt");
